...
static void __sti____cudaRegisterAll_25_ksync_uint_dep128_cpp1_ii_27cf04ef(void) __attribute__((__constructor__));
...
static void __nv_cudaEntityRegisterCallback( void **__T20) {  __nv_dummy_param_ref(__T20); __nv_save_fatbinhandle_for_managed_rt(__T20); __cudaRegisterEntry(__T20, ((void ( *)(unsigned *, unsigned *, unsigned, unsigned, int))K_SYNC_UINT_DEP128), K_SYNC_UINT_DEP128, (-1)); }
static void __sti____cudaRegisterAll_25_ksync_uint_dep128_cpp1_ii_27cf04ef(void) {  __cudaRegisterBinary(__nv_cudaEntityRegisterCallback);  }
